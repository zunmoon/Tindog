...
<div class="container">
  ...
  <input type="search" value="${SUBJECT}" name="subject" placeholder="Search" class="search-input">
  ...
  <button type="button" onclick="location.href='write'" class="pbtn">글쓰기</button>
  <button type="button" onclick="location.href='list'" class="pbtn">전체목록으로 돌아가기</button>  
